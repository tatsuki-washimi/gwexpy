...
- [Bootstrap PSD and GLS Fitting](../user_guide/tutorials/case_bootstrap_gls_fitting.ipynb)
...
- aligned grid analysis: [SpectrogramMatrix](SpectrogramMatrix.md)
- practical workflows: [Bootstrap PSD and GLS Fitting](../user_guide/tutorials/case_bootstrap_gls_fitting.ipynb), [Glitch Analysis](../user_guide/tutorials/case_glitch_analysis.ipynb)

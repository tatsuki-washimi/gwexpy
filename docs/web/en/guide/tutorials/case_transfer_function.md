...
- Japanese page (HTML): :doc:`../../../ja/guide/tutorials/case_transfer_function`
- Japanese notebook (download): [case_transfer_function.ipynb](../../../ja/guide/tutorials/case_transfer_function.ipynb)

...
| --- | --- | --- |
| Declared GWexpy extras | `zarr`, `netCDF4`, `xarray`, `obspy`, `mth5`, `lalsuite`, `gwinc`, `control`, `pydub` | Install the required extra from PyPI, for example `pip install "gwexpy[control]"`. |

...
```python
bootstrap_asd(self, n_boot=1000, average='median', ci=0.68, window='hann', nperseg=None, noverlap=None, ignore_nan=True)
```
...
```python
degree(self, unwrap: 'bool' = False) -> "'Spectrogram'"
```
...
```python
from_mne(tfr: 'Any', **kwargs: 'Any') -> 'Any'
```
...
```python
from_obspy(stream: 'Any', **kwargs: 'Any') -> 'Any'
```
...
```python
radian(self, unwrap: 'bool' = False) -> "'Spectrogram'"
```

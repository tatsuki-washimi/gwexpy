...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Test and verify code blocks in Quickstart documentation."
    )
    parser.add_argument(
        "--lang",
        default="ja",
        choices=["ja", "en"],
        help="Language sub-directory to test.",
    )
    ...
    for i, block in enumerate(blocks, 1):
        ...
        if rc != 0:
            failures.append({"index": i, "rc": rc, "stderr": err, "stdout": out})

...
#   - all tags pushed:     git push origin v0.1.12  (push only the release tag; earlier tags must already exist on origin)
#
# Behaviour:
...
#   - Only v0.1.12 is marked as the latest release.
#
# Usage:
...
LATEST_TAG="v0.1.12"
VERSIONS=(0.1.0 0.1.1 0.1.2 0.1.3 0.1.4 0.1.5 0.1.6 0.1.7 0.1.8 0.1.9 0.1.10 0.1.11 0.1.12)

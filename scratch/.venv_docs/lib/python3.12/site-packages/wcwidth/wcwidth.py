...
def wcwidth(wc: str, unicode_version: str = 'auto', ambiguous_width: int = 1) -> int:  # pylint: disable=unused-argument
    r"""Given one Unicode codepoint, return its printable length on a terminal.
...
def iter_sequences(text: str) -> Iterator[tuple[str, bool]]:
    r"""Iterate through text, yielding segments with sequence identification.
...
def width(
    ...
    *,
    ...
    r"""Return printable width of text containing many kinds of control codes and sequences.
...
def ljust(
    ...
    *,
    ...
    r"""Return text left-justified in a string of given display width.
...
def rjust(
    ...
    *,
    ...
    r"""Return text right-justified in a string of given display width.
...
def center(
    ...
    *,
    ...
    r"""Return text centered in a string of given display width.
...
def strip_sequences(text: str) -> str:
    r"""Return text with all terminal escape sequences removed.
...
def clip(
    ...
    *,
    ...
    r"""Clip text to display columns ``(start, end)`` while preserving all terminal sequences.

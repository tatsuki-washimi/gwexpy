...
def iter_graphemes(
    ...
    r"""Iterate over grapheme clusters in a Unicode string.
...
def grapheme_boundary_before(unistr: str, pos: int) -> int:
    r"""Find the grapheme cluster boundary immediately before a position.
...
def iter_graphemes_reverse(
    ...
    r"""Iterate over grapheme clusters in reverse order (last to first).

...
def write_test_pickle(to_pickle, args):
    ...
    pickle_filename = f"joblib_{joblib_version}{body}_pickle_py{py_version}_np{numpy_version}{extension}"
    ...
    try:
        ...
        print(
            f"Error: cannot generate file '{pickle_filename}' with arguments '{kwargs}'. "
            f"Error was: {e}"
        )
    else:
        print(f"File '{pickle_filename}' generated successfully.")

...
def _validate_l1_method(method):
    ...
    if method not in ['l1', 'l1_cvxopt_cp']:
        raise ValueError(f'`method` = {method} is not supported, use either '
                         '"l1" or "l1_cvxopt_cp"')
...
class Poisson(CountModel):
    ...
    def fit_constrained(self, constraints, start_params=None, **fit_kwds):
        ...
        **fit_kwds : keyword arguments
        ...
        from statsmodels.base._constraints import LinearConstraints, fit_constrained
...
class NegativeBinomial(CountModel):
    ...
    def loglike(self, params):
        r"""Loglikelihood for negative binomial model

...
class ARDL(AutoReg):
    r"""Autoregressive Distributed Lag (ARDL) Model
...
class UECM(ARDL):
    r"""Unconstrained Error Correlation Model(UECM)
...
class UECMResults(ARDLResults):
    ...
    def bounds_test(
        ...
        r"""Cointegration bounds test of Pesaran, Shin, and Smith

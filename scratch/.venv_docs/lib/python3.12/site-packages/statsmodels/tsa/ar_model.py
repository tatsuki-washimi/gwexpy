...
class AutoRegResults(tsa_model.TimeSeriesModelResults):
    ...
    @cache_readonly
    def aic(self):
        r"""Akaike Information Criterion using Lutkepohl's definition.
    ...
    @cache_readonly
    def hqic(self):
        r"""Hannan-Quinn Information Criterion using Lutkepohl's definition.
    ...
    @cache_readonly
    def fpe(self):
        r"""Final prediction error using Lütkepohl's definition.
    ...
    @cache_readonly
    def aicc(self):
        r"""Akaike Information Criterion with small sample correction

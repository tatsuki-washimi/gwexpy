...
class KalmanFilter(Representation):
    ...
    **kwargs
    ...
    def set_stability_method(self, stability_method=None, **kwargs):
        r"""Set the numerical stability method
    ...
    def set_conserve_memory(self, conserve_memory=None, **kwargs):
        r"""Set the memory conservation method
    ...
    def set_filter_timing(self, alternate_timing=None, **kwargs):
        r"""Set the filter timing convention
    ...
    def filter(self, filter_method=None, inversion_method=None,
        ...
        r"""Apply the Kalman filter to the statespace model.
    ...
    def loglike(self, **kwargs):
        r"""Calculate the loglikelihood associated with the statespace model.
    ...
    def loglikeobs(self, **kwargs):
        r"""Calculate the loglikelihood for each observation associated with the
        statespace model.
...
class FilterResults(FrozenRepresentation):
    ...
    def standardized_forecasts_error(self):
        r"""Standardized forecast errors
    ...
    def predict(self, start=None, end=None, dynamic=None, **kwargs):
        r"""In-sample and out-of-sample prediction for state space models generally
...
class PredictionResults(FilterResults):
    r"""Results of in-sample and out-of-sample prediction for state space models
    generally

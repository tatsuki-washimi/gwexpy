...
class CFASimulationSmoother:
    r""""Cholesky Factor Algorithm" (CFA) simulation smoother
    ...
    **Not-yet-implemented**:
    ...
    def posterior_mean(self):
        r"""Posterior mean of the states conditional on the data
    ...
    def posterior_cov_inv_chol_sparse(self):
        r"""Sparse Cholesky factor of inverse posterior covariance matrix
    ...
    def posterior_cov(self):
        r"""Posterior covariance of the states conditional on the data
    ...
    def simulate(self, variates=None, update_posterior=True):
        r"""Perform simulation smoothing (via Cholesky factor algorithm)

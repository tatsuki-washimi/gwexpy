...
class SimulationSmoother(KalmanSmoother):
    r"""State space representation of a time series process, with Kalman filter
    ...
    **kwargs
    ...
    def get_simulation_output(self, simulation_output=None,
        ...
        r"""Get simulation output bitmask
    ...
    def simulation_smoother(self, simulation_output=None, method='kfs',
        ...
        r"""Retrieve a simulation smoother for the statespace model.
...
class SimulationSmoothResults:
    r"""Results from applying the Kalman smoother and/or filter to a state space
    model.
    ...
    def generated_measurement_disturbance(self):
        r"""Randomly drawn measurement disturbance variates
    ...
    def generated_state_disturbance(self):
        r"""Randomly drawn state disturbance variates, used to construct
    ...
    def generated_obs(self):
        r"""Generated vector of observations by iterating on the observation and
    ...
    def generated_state(self):
        r"""Generated vector of states by iterating on the transition equation,
    ...
    def simulated_state(self):
        r"""Random draw of the state vector from its conditional distribution.
    ...
    def simulated_measurement_disturbance(self):
        r"""Random draw of the measurement disturbance vector from its conditional
        distribution.
    ...
    def simulated_state_disturbance(self):
        r"""Random draw of the state disturbanc e vector from its conditional
        distribution.
    ...
    def simulate(self, simulation_output=-1,
                 ...
                 random_state=None):
        r"""Perform simulation smoothing

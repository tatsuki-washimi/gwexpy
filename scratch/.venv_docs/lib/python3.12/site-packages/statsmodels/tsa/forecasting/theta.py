r"""Implementation of the Theta forecasting method of
...
class ThetaModel:
    r"""The Theta forecasting model of Assimakopoulos and Nikolopoulos (2000)
...
class ThetaModelResults:
    ...
    def forecast(self, steps: int = 1, theta: float = 2) -> pd.Series:
        r"""Forecast the model for a given theta
    ...
    def forecast_components(self, steps: int = 1) -> pd.DataFrame:
        r"""Compute the three components of the Theta model forecast
    ...
    def plot_predict(
        ...
        r"""Plot forecasts, prediction intervals and in-sample values

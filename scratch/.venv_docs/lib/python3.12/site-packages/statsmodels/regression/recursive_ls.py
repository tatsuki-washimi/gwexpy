...
class RecursiveLSResults(MLEResults):
    ...
    @cache_readonly
    def cusum(self):
        r"""Cumulative sum of standardized recursive residuals statistics
    ...
    def cusum_squares(self):
        r"""Cumulative sum of squares of standardized recursive residuals
        statistics
    ...
    def plot_recursive_coefficient(self, variables=0, alpha=0.05,
                                   ...
                                   figsize=None):
        r"""Plot the recursively estimated coefficients on a given variable
    ...
    def plot_cusum(self, alpha=0.05, legend_loc='upper left',
        ...
        r"""Plot the CUSUM statistic and significance bounds.
    ...
    def plot_cusum_squares(self, alpha=0.05, legend_loc='upper left',
                           fig=None, figsize=None):
        r"""Plot the CUSUM of squares statistic and significance bounds.

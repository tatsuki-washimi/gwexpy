...
class GLS(RegressionModel):
    ...
    def loglike(self, params):
        r"""Compute the value of the Gaussian log-likelihood function at params.
...
class RegressionResults(base.LikelihoodModelResults):
    r"""This class summarizes the fit of a linear regression model.
    ...
    **kwargs
    ...
    @cache_readonly
    def aic(self):
        r"""Akaike's information criteria.

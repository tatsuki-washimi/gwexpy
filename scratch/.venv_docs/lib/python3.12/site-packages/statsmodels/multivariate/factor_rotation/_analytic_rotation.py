...
def target_rotation(A, H, full_rank=False):
    r"""Analytically performs orthogonal rotations towards a target matrix,
    i.e., we minimize:
...
def procrustes(A, H):
    r"""Analytically solves the following Procrustes problem:
...
def promax(A, k=2):
    r"""Performs promax rotation of the matrix :math:`A`.

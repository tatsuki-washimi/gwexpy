...
class KernelReg(GenericKDE):
    ...
    def cv_loo(self, bw, func):
        r"""The cross-validation function with leave-one-out estimator.
    ...
    def r_squared(self):
        r"""Returns the R-Squared for the nonparametric regression.
...
class KernelCensoredReg(KernelReg):
    ...
    def cv_loo(self, bw, func):
        r"""The cross-validation function with leave-one-out
        estimator

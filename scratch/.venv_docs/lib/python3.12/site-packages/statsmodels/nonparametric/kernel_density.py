...
class KDEMultivariate(GenericKDE):
    ...
    def loo_likelihood(self, bw, func=lambda x: x):
        r"""Returns the leave-one-out likelihood function.
    ...
    def imse(self, bw):
        r"""Returns the Integrated Mean Square Error for the unconditional KDE.
...
class KDEMultivariateConditional(GenericKDE):
    ...
    def cdf(self, endog_predict=None, exog_predict=None):
        r"""Cumulative distribution function for the conditional density.
    ...
    def imse(self, bw):
        r"""The integrated mean square error for the conditional KDE.

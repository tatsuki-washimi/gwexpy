...
class HuberT(RobustNorm):
    ...
    def rho(self, z):
        r"""The robust criterion function for Huber's t.
    ...
    def psi(self, z):
        r"""The psi function for Huber's t estimator
...
class RamsayE(RobustNorm):
    ...
    def rho(self, z):
        r"""The robust criterion function for Ramsay's Ea.
    ...
    def psi(self, z):
        r"""The psi function for Ramsay's Ea estimator
    ...
    def weights(self, z):
        r"""Ramsay's Ea weighting function for the IRLS algorithm
...
class AndrewWave(RobustNorm):
    ...
    def rho(self, z):
        r"""The robust criterion function for Andrew's wave.
    ...
    def psi(self, z):
        r"""The psi function for Andrew's wave
    ...
    def weights(self, z):
        r"""Andrew's wave weighting function for the IRLS algorithm
...
class TrimmedMean(RobustNorm):
    ...
    def rho(self, z):
        r"""The robust criterion function for least trimmed mean.
    ...
    def psi(self, z):
        r"""The psi function for least trimmed mean
    ...
    def weights(self, z):
        r"""Least trimmed mean weighting function for the IRLS algorithm
...
class Hampel(RobustNorm):
    ...
    def rho(self, z):
        r"""The robust criterion function for Hampel's estimator
    ...
    def psi(self, z):
        r"""The psi function for Hampel's estimator
    ...
    def weights(self, z):
        r"""Hampel weighting function for the IRLS algorithm
...
class TukeyBiweight(RobustNorm):
    ...
    def rho(self, z):
        r"""The robust criterion function for Tukey's biweight estimator
    ...
    def weights(self, z):
        r"""Tukey's biweight weighting function for the IRLS algorithm

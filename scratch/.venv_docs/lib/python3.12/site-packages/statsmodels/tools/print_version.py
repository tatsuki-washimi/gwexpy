...
def show_versions(show_dirs=True):
    ...
    print('\nstatsmodels\n===========\n')
    if has_sm:
        print(f'Installed: {safe_version(statsmodels)} ({dirname(statsmodels.__file__)})')
    else:
        print('Not installed')
    ...
    try:
        import dateutil
        print(f"    dateutil: {safe_version(dateutil)} ({dirname(dateutil.__file__)})")
    except ImportError:
        print("    dateutil: not installed")
    ...
    try:
        import pygments
        print(f"    pygments: {safe_version(pygments)} ({dirname(pygments.__file__)})")
    except ImportError:
        print("    pygments: Not installed")
    ...
    try:
        import virtualenv
        print(f"virtualenv: {safe_version(virtualenv)} ({dirname(virtualenv.__file__)})")
    except ImportError:
        print("virtualenv: Not installed")

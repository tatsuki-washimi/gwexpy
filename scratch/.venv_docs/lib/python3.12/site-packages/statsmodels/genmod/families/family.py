...
class Family:
    ...
    def starting_mu(self, y):
        r"""Starting value for mu in the IRLS algorithm.
    ...
    def deviance(self, endog, mu, var_weights=1., freq_weights=1., scale=1.):
        r"""The deviance function evaluated at (endog, mu, var_weights,
    ...
    def fitted(self, lin_pred):
        r"""Fitted values based on linear predictors lin_pred.
    ...
    def loglike_obs(self, endog, mu, var_weights=1., scale=1.):
        r"""The log-likelihood function for each observation in terms of the fitted
...
class Poisson(Family):
    ...
    def get_distribution(self, mu, scale=1., var_weights=1.):
        r"""Frozen Poisson distribution instance for given parameters
...
class Gaussian(Family):
    ...
    def get_distribution(self, mu, scale, var_weights=1.):
        r"""Frozen Gaussian distribution instance for given parameters
...
class Gamma(Family):
    ...
    def get_distribution(self, mu, scale, var_weights=1.):
        r"""Frozen Gamma distribution instance for given parameters
...
class Binomial(Family):
    ...
    def starting_mu(self, y):
        r"""The starting values for the IRLS algorithm for the Binomial family.
    ...
    def get_distribution(self, mu, scale=1., var_weights=1., n_trials=1):
        r"""Frozen Binomial distribution instance for given parameters
...
class InverseGaussian(Family):
    ...
    def _resid_dev(self, endog, mu):
        r"""Inverse Gaussian deviance residuals
    ...
    def get_distribution(self, mu, scale, var_weights=1.):
        r"""Frozen Inverse Gaussian distribution instance for given parameters
...
class NegativeBinomial(Family):
    r"""Negative Binomial exponential family (corresponds to NB2).
    ...
    def _resid_dev(self, endog, mu):
        r"""Negative Binomial deviance residuals
    ...
    def get_distribution(self, mu, scale=1., var_weights=1.):
        r"""Frozen NegativeBinomial distribution instance for given parameters

...
import h5py
from h5py import Dataset, Datatype, ExternalLink, File, Group, HardLink, SoftLink, h5t
from h5py._hl.compat import filename_encode

from .common import TestCase, is_main_thread, make_name, ut
...
class TestContains(BaseGroup):
    ...
    def test_contains(self):
        ...
        self.assertIn(name, self.f)
        self.assertIn(f"/{name}".encode(), self.f)

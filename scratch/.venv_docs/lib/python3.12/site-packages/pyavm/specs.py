...
SPECS[1.1] = {
    ...
    "Image.ProductQuality": AVMStringCVCapitalize(
        "avm:Image.ProductQuality", IMAGE_PRODUCT_QUALITY_CHOICES
    ),
    # Observation Metadata
    "Facility": AVMOrderedList("avm:Facility"),
    "Instrument": AVMOrderedList("avm:Instrument"),
    "Spectral.ColorAssignment": AVMOrderedListCV(
        "avm:Spectral.ColorAssignment", SPECTRAL_COLOR_ASSIGNMENT_CHOICES
    ),
    ...
    # Coordinate Metadata
    "Spatial.CoordinateFrame": AVMStringCVUpper(
        "avm:Spatial.CoordinateFrame", SPATIAL_COORDINATE_FRAME_CHOICES
    ),
    "Spatial.Equinox": AVMString("avm:Spatial.Equinox"),
    "Spatial.ReferenceValue": AVMOrderedFloatList(
        "avm:Spatial.ReferenceValue", length=2, strict_length=True
    ),
    "Spatial.ReferenceDimension": AVMOrderedFloatList(
        "avm:Spatial.ReferenceDimension", length=2, strict_length=True
    ),
    "Spatial.ReferencePixel": AVMOrderedFloatList(
        "avm:Spatial.ReferencePixel", length=2, strict_length=True
    ),
    ...
    "Spatial.CoordsystemProjection": AVMStringCVUpper(
        "avm:Spatial.CoordsystemProjection", SPATIAL_COORDSYSTEM_PROJECTION_CHOICES
    ),
    ...
    "Spatial.CDMatrix": AVMOrderedFloatList(
        "avm:Spatial.CDMatrix", length=4, strict_length=True, deprecated=True
    ),
    # Publisher Metadata

...
import pytest
import scipy.signal
from matplotlib.pyplot import figure, legend, plot, subplot2grid
from numpy import array, linspace, matrix, r_, zeros
from numpy.testing import assert_array_almost_equal

from control.matlab import dcgain, impulse, initial, lsim, ss, ss2tf, step

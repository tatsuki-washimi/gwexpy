...
class SpeStack(FramesSequence):
    ...
    def get_frame(self, j):
        if j >= self._len:
            raise ValueError(f"Frame number {j} out of range.")
...
Length: {self._len} frames
Frame Shape: {self._width} x {self._height}
Pixel Datatype: {self._dtype}"""

...
class Rule:
    ...
    def estimate(self, f, a, b, args=()):
        r"""Calculate estimate of integral of `f` in rectangular region described by
        corners `a` and ``b``.
    ...
    def estimate_error(self, f, a, b, args=()):
        r"""Estimate the error of the approximation for the integral of `f` in rectangular
...
class NestedFixedRule(FixedRule):
    r"""A cubature rule with error estimate given by the difference between two underlying
    fixed rules.

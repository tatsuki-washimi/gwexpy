...
from . import _dierckx, _fitpack_impl
...
class BSpline:
    ...
    **Implementation details**
    ...
    def from_power_basis(cls, pp, bc_type='not-a-knot'):
        r"""Construct a polynomial in the B-spline basis
...
def _compute_optimal_gcv_parameter(X, wE, y, w):
    ...
    def _gcv(lam, X, XtWX, wE, XtE, y):
        r"""Computes the generalized cross-validation criteria [1].
...
def make_smoothing_spline(x, y, w=None, lam=None, *, axis=0):
    r"""Create a smoothing B-spline satisfying the Generalized Cross Validation (GCV) criterion.

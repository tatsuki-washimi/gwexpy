...
# Local imports
from scipy.linalg import LinAlgError, LinAlgWarning, bandwidth
...
from ._matfuncs_expm import pade_UV_calc, pick_pade_structure
...
def khatri_rao(a, b):
    r"""Khatri-Rao product of two matrices.

...
def tangential_byrd_omojokun(grad, hess_prod, xl, xu, delta, debug, **kwargs):
    r"""Minimize approximately a quadratic function subject to bound constraints in
    a trust region.
...
def constrained_tangential_byrd_omojokun(
    ...
    **kwargs,
    ...
    r"""Minimize approximately a quadratic function subject to bound and linear
...
def normal_byrd_omojokun(aub, bub, aeq, beq, xl, xu, delta, debug, **kwargs):
    r"""Minimize approximately a linear constraint violation subject to bound
    constraints in a trust region.

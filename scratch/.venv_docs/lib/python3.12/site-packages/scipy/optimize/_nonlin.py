...
from scipy._lib._util import _dedent_for_py313, copy_if_needed
from scipy._lib._util import getfullargspec_no_self as _getfullargspec
from scipy.linalg import LinAlgError, get_blas_funcs, inv, norm, qr, solve, svd

from ._linesearch import scalar_search_armijo, scalar_search_wolfe1

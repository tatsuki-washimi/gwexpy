...
class lti(LinearTimeInvariant):
    r"""Continuous-time linear time invariant system base class.
...
class dlti(LinearTimeInvariant):
    r"""Discrete-time linear time invariant system base class.
...
def dfreqresp(system, w=None, n=10000, whole=False):
    r"""Calculate the frequency response of a discrete-time system.

...
from ._stats_pythran import _concordant_pairs as _P
from ._stats_pythran import _discordant_pairs as _Q
...
def poisson_means_test(k1, n1, k2, n2, *, diff=0, alternative='two-sided'):
    r"""Performs the Poisson means test, AKA the "E-test".
...
def _get_binomial_log_p_value_with_nuisance_param(
    ...
    r"""Compute the log pvalue in respect of a nuisance parameter considering
    a 2x2 sample space.

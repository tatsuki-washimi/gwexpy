...
from ._axis_nan_policy import _broadcast_arrays, _broadcast_concatenate
...
def bootstrap(data, statistic, *, n_resamples=9999, batch=None,
              ...
              rng=None):
    r"""Compute a two-sided bootstrap confidence interval of a statistic.
...
def permutation_test(data, statistic, *, permutation_type='independent',
    ...
    r"""Performs a permutation test of a given statistic on provided data.

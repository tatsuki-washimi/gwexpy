...
from scipy._lib._util import _contains_nan, _dedent_for_py313, _rename_parameter
...
def linregress(x, y=None):
    r"""Calculate a linear least-squares regression for two sets of measurements.
...
def siegelslopes(y, x=None, method="hierarchical"):
    r"""Computes the Siegel estimator for a set of points (x, y).
...
def sen_seasonal_slopes(x):
    r"""Computes seasonal Theil-Sen and Kendall slope estimators.

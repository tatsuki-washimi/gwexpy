...
import numpy as np
from numpy import asarray, can_cast, concatenate, conj, imag, ndarray, ones, real, zeros
...
def mmwrite(target, a, comment='', field=None, precision=None, symmetry=None):
    r"""Writes the sparse or dense array `a` to Matrix Market file-like `target`.

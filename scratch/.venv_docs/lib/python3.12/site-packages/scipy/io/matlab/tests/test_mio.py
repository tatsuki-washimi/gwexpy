...
from scipy.io.matlab import MatlabFunction, MatlabObject, MatlabOpaque
from scipy.io.matlab._mio import loadmat, mat_reader_factory, savemat, whosmat
...
from scipy.sparse import coo_array, csc_array, eye_array, issparse

                ...
                if config:
                    for filename, earlier_config in zip(filenames, loaded):
                        ...
                        if collisions and log:
                            log.warning(
                                f"Collisions detected in {filename} and {loader.full_filename} config files."  # noqa: G001
                                f" {loader.full_filename} has higher priority: {json.dumps(collisions, indent=2)}"
                            )

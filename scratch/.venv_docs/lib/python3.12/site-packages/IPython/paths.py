...
def get_ipython_dir() -> str:
        ...
        if xdg_dir:
            ...
            if _writable_dir(xdg_ipdir):
                ...
                if os.path.exists(ipdir):
                    ...
                    warn(f'{cu(xdg_ipdir)} is deprecated. Move link to {cu(ipdir)} to '
    ...
    if os.path.exists(ipdir) and not _writable_dir(ipdir):
        ...
        warn(f"IPython dir '{ipdir}' is not a writable location,"
        ...
        if not _writable_dir(parent):
            ...
            warn(f"IPython parent '{parent}' is not a writable location,"
                    " using a temp directory.")
            ipdir = tempfile.mkdtemp()
        else:

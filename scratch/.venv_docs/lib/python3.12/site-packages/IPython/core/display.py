...
class Image(DisplayObject):
    ...
    def _repr_html_(self):
        if not self.embed:
            ...
            return f'<img src="{self.url}"{width}{height}{klass}{alt}/>'
...
class Video(DisplayObject):
    ...
    def _repr_html_(self):
        ...
        if not self.embed:
            ...
            output = f"""<video src="{url}" {self.html_attributes} {width} {height}>
      Your browser does not support the <code>video</code> element.
        ...
        output = f"""<video {self.html_attributes} {width} {height}>
 <source src="data:{mimetype};base64,{b64_video}" type="{mimetype}">

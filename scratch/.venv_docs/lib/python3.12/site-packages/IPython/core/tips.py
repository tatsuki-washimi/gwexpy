...
_tips: Any = {
    ...
    "every_year": {
        ...
        (
            10,
            11,
        ): f"IPython's first line of code was written {datetime.now().year - 2001} years ago by Fernando Pérez",
        (
            12,
            9,
        ): f"IPython 0.0.2 was announced {datetime.now().year - 2001} years ago: https://mail.python.org/pipermail/python-list/2001-December/093408.html",
        (
            3,
            8,

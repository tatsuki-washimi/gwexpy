...
class SerbianStemmer(BaseStemmer):
    ...
    g_ca = {"b", "v", "g", "d", "z", "j", "k", "l", "m", "n", "p", "r", "s", "t", "f", "h", "c", "č", "ć", "ž", "š", "đ"}
                        ...
                        while True:
                            ...
                            try:
                                ...
                                if among_var == 1:
                                    ...
                                    if not self.slice_from("đ"):
                                        return False
                                elif among_var == 7:
                                    if not self.slice_from("e"):
                                        return False
                                elif among_var == 8:
                                    if not self.slice_from("ž"):
                                        return False
                                elif among_var == 9:
                                    ...
                                    if not self.slice_from("č"):
                                        return False
                                elif among_var == 29:
                                    if not self.slice_from("dž"):
                                        return False
                                else:
                                    if not self.slice_from("š"):
                                        return False
                                self.cursor = v_3
                                raise lab2()
                            except lab3: pass
    ...
    def __r_Step_1(self):
        ...
        self.bra = self.cursor
        if among_var == 1:
            if not self.slice_from("loga"):
                return False
        elif among_var == 2:
            if not self.slice_from("peh"):
                return False
        elif among_var == 3:
            if not self.slice_from("vojka"):
                return False
        elif among_var == 4:
            if not self.slice_from("bojka"):
                return False
        elif among_var == 5:
            if not self.slice_from("jak"):
                return False
        elif among_var == 6:
            if not self.slice_from("čajni"):
                return False
        elif among_var == 7:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("cajni"):
                return False
        elif among_var == 8:
            if not self.slice_from("erni"):
                return False
        elif among_var == 9:
            if not self.slice_from("larni"):
                return False
        elif among_var == 10:
            if not self.slice_from("esni"):
                return False
        elif among_var == 11:
            if not self.slice_from("anjca"):
                return False
        elif among_var == 12:
            if not self.slice_from("ajca"):
                return False
        elif among_var == 13:
            if not self.slice_from("ljca"):
                return False
        elif among_var == 14:
            if not self.slice_from("ejca"):
                return False
        elif among_var == 15:
            if not self.slice_from("ojca"):
                return False
        elif among_var == 16:
            if not self.slice_from("ajka"):
                return False
        elif among_var == 17:
            if not self.slice_from("ojka"):
                return False
        elif among_var == 18:
            if not self.slice_from("šca"):
                return False
        elif among_var == 19:
            if not self.slice_from("ing"):
                return False
        elif among_var == 20:
            if not self.slice_from("tvenik"):
                return False
        elif among_var == 21:
            if not self.slice_from("tetika"):
                return False
        elif among_var == 22:
            if not self.slice_from("nstva"):
                return False
        elif among_var == 23:
            if not self.slice_from("nik"):
                return False
        elif among_var == 24:
            if not self.slice_from("tik"):
                return False
        elif among_var == 25:
            if not self.slice_from("zik"):
                return False
        elif among_var == 26:
            if not self.slice_from("snik"):
                return False
        elif among_var == 27:
            if not self.slice_from("kusi"):
                return False
        elif among_var == 28:
            if not self.slice_from("kusni"):
                return False
        elif among_var == 29:
            if not self.slice_from("kustva"):
                return False
        elif among_var == 30:
            if not self.slice_from("dušni"):
                return False
        elif among_var == 31:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("dusni"):
                return False
        elif among_var == 32:
            if not self.slice_from("antni"):
                return False
        elif among_var == 33:
            if not self.slice_from("bilni"):
                return False
        elif among_var == 34:
            if not self.slice_from("tilni"):
                return False
        elif among_var == 35:
            if not self.slice_from("avilni"):
                return False
        elif among_var == 36:
            if not self.slice_from("silni"):
                return False
        elif among_var == 37:
            if not self.slice_from("gilni"):
                return False
        elif among_var == 38:
            if not self.slice_from("rilni"):
                return False
        elif among_var == 39:
            if not self.slice_from("nilni"):
                return False
        elif among_var == 40:
            if not self.slice_from("alni"):
                return False
        elif among_var == 41:
            if not self.slice_from("ozni"):
                return False
        elif among_var == 42:
            if not self.slice_from("ravi"):
                return False
        elif among_var == 43:
            if not self.slice_from("stavni"):
                return False
        elif among_var == 44:
            if not self.slice_from("pravni"):
                return False
        elif among_var == 45:
            if not self.slice_from("tivni"):
                return False
        elif among_var == 46:
            if not self.slice_from("sivni"):
                return False
        elif among_var == 47:
            if not self.slice_from("atni"):
                return False
        elif among_var == 48:
            if not self.slice_from("enta"):
                return False
        elif among_var == 49:
            if not self.slice_from("tetni"):
                return False
        elif among_var == 50:
            if not self.slice_from("pletni"):
                return False
        elif among_var == 51:
            if not self.slice_from("šavi"):
                return False
        elif among_var == 52:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("savi"):
                return False
        elif among_var == 53:
            if not self.slice_from("anta"):
                return False
        elif among_var == 54:
            if not self.slice_from("ačka"):
                return False
        elif among_var == 55:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("acka"):
                return False
        elif among_var == 56:
            if not self.slice_from("uška"):
                return False
        elif among_var == 57:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("uska"):
                return False
        elif among_var == 58:
            if not self.slice_from("atka"):
                return False
        elif among_var == 59:
            if not self.slice_from("etka"):
                return False
        elif among_var == 60:
            if not self.slice_from("itka"):
                return False
        elif among_var == 61:
            if not self.slice_from("otka"):
                return False
        elif among_var == 62:
            if not self.slice_from("utka"):
                return False
        elif among_var == 63:
            if not self.slice_from("eskna"):
                return False
        elif among_var == 64:
            if not self.slice_from("tični"):
                return False
        elif among_var == 65:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("ticni"):
                return False
        elif among_var == 66:
            if not self.slice_from("ojska"):
                return False
        elif among_var == 67:
            if not self.slice_from("esma"):
                return False
        elif among_var == 68:
            if not self.slice_from("metra"):
                return False
        elif among_var == 69:
            if not self.slice_from("centra"):
                return False
        elif among_var == 70:
            if not self.slice_from("istra"):
                return False
        elif among_var == 71:
            if not self.slice_from("osti"):
                return False
        elif among_var == 72:
            if not self.B_no_diacritics:
                return False
            ...
            if not self.slice_from("dba"):
                return False
        elif among_var == 74:
            if not self.slice_from("čka"):
                return False
        elif among_var == 75:
            if not self.slice_from("mca"):
                return False
        elif among_var == 76:
            if not self.slice_from("nca"):
                return False
        elif among_var == 77:
            if not self.slice_from("voljni"):
                return False
        elif among_var == 78:
            if not self.slice_from("anki"):
                return False
        elif among_var == 79:
            if not self.slice_from("vca"):
                return False
        elif among_var == 80:
            if not self.slice_from("sca"):
                return False
        elif among_var == 81:
            if not self.slice_from("rca"):
                return False
        elif among_var == 82:
            if not self.slice_from("alca"):
                return False
        elif among_var == 83:
            if not self.slice_from("elca"):
                return False
        elif among_var == 84:
            if not self.slice_from("olca"):
                return False
        elif among_var == 85:
            if not self.slice_from("njca"):
                return False
        elif among_var == 86:
            if not self.slice_from("ekta"):
                return False
        elif among_var == 87:
            if not self.slice_from("izma"):
                return False
        elif among_var == 88:
            if not self.slice_from("jebi"):
                return False
        elif among_var == 89:
            if not self.slice_from("baci"):
                return False
        elif among_var == 90:
            if not self.slice_from("ašni"):
                return False
        else:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("asni"):
                return False
        return True
    ...
    def __r_Step_2(self):
        ...
        if not self.__r_R1():
            return False
        if among_var == 1:
            if not self.slice_from("sk"):
                return False
        elif among_var == 2:
            if not self.slice_from("šk"):
                return False
        elif among_var == 3:
            if not self.slice_from("stv"):
                return False
        elif among_var == 4:
            if not self.slice_from("štv"):
                return False
        elif among_var == 5:
            if not self.slice_from("tanij"):
                return False
        elif among_var == 6:
            if not self.slice_from("manij"):
                return False
        elif among_var == 7:
            if not self.slice_from("panij"):
                return False
        elif among_var == 8:
            if not self.slice_from("ranij"):
                return False
        elif among_var == 9:
            if not self.slice_from("ganij"):
                return False
        elif among_var == 10:
            if not self.slice_from("an"):
                return False
        elif among_var == 11:
            if not self.slice_from("in"):
                return False
        elif among_var == 12:
            if not self.slice_from("on"):
                return False
        elif among_var == 13:
            if not self.slice_from("n"):
                return False
        elif among_var == 14:
            if not self.slice_from("ać"):
                return False
        elif among_var == 15:
            if not self.slice_from("eć"):
                return False
        elif among_var == 16:
            if not self.slice_from("uć"):
                return False
        elif among_var == 17:
            if not self.slice_from("ugov"):
                return False
        elif among_var == 18:
            if not self.slice_from("ug"):
                return False
        elif among_var == 19:
            ...
            if not self.slice_from("rari"):
                return False
        elif among_var == 22:
            if not self.slice_from("oti"):
                return False
        elif among_var == 23:
            if not self.slice_from("si"):
                return False
        elif among_var == 24:
            if not self.slice_from("li"):
                return False
        elif among_var == 25:
            if not self.slice_from("uj"):
                return False
        elif among_var == 26:
            if not self.slice_from("caj"):
                return False
        elif among_var == 27:
            if not self.slice_from("čaj"):
                return False
        elif among_var == 28:
            if not self.slice_from("ćaj"):
                return False
        elif among_var == 29:
            if not self.slice_from("đaj"):
                return False
        elif among_var == 30:
            if not self.slice_from("laj"):
                return False
        elif among_var == 31:
            if not self.slice_from("raj"):
                return False
        elif among_var == 32:
            if not self.slice_from("bij"):
                return False
        elif among_var == 33:
            if not self.slice_from("cij"):
                return False
        elif among_var == 34:
            if not self.slice_from("dij"):
                return False
        elif among_var == 35:
            if not self.slice_from("lij"):
                return False
        elif among_var == 36:
            if not self.slice_from("nij"):
                return False
        elif among_var == 37:
            if not self.slice_from("mij"):
                return False
        elif among_var == 38:
            if not self.slice_from("žij"):
                return False
        elif among_var == 39:
            if not self.slice_from("gij"):
                return False
        elif among_var == 40:
            if not self.slice_from("fij"):
                return False
        elif among_var == 41:
            if not self.slice_from("pij"):
                return False
        elif among_var == 42:
            if not self.slice_from("rij"):
                return False
        elif among_var == 43:
            if not self.slice_from("sij"):
                return False
        elif among_var == 44:
            if not self.slice_from("tij"):
                return False
        elif among_var == 45:
            if not self.slice_from("zij"):
                return False
        elif among_var == 46:
            if not self.slice_from("nal"):
                return False
        elif among_var == 47:
            if not self.slice_from("ijal"):
                return False
        elif among_var == 48:
            if not self.slice_from("ozil"):
                return False
        elif among_var == 49:
            if not self.slice_from("olov"):
                return False
        elif among_var == 50:
            if not self.slice_from("ol"):
                return False
        elif among_var == 51:
            if not self.slice_from("lem"):
                return False
        elif among_var == 52:
            if not self.slice_from("ram"):
                return False
        elif among_var == 53:
            if not self.slice_from("ar"):
                return False
        elif among_var == 54:
            if not self.slice_from("dr"):
                return False
        elif among_var == 55:
            if not self.slice_from("er"):
                return False
        elif among_var == 56:
            if not self.slice_from("or"):
                return False
        elif among_var == 57:
            if not self.slice_from("es"):
                return False
        elif among_var == 58:
            if not self.slice_from("is"):
                return False
        elif among_var == 59:
            if not self.slice_from("taš"):
                return False
        elif among_var == 60:
            if not self.slice_from("naš"):
                return False
        elif among_var == 61:
            if not self.slice_from("jaš"):
                return False
        elif among_var == 62:
            if not self.slice_from("kaš"):
                return False
        elif among_var == 63:
            if not self.slice_from("baš"):
                return False
        elif among_var == 64:
            if not self.slice_from("gaš"):
                return False
        elif among_var == 65:
            if not self.slice_from("vaš"):
                return False
        elif among_var == 66:
            if not self.slice_from("eš"):
                return False
        elif among_var == 67:
            if not self.slice_from("iš"):
                return False
        elif among_var == 68:
            if not self.slice_from("ikat"):
                return False
        elif among_var == 69:
            if not self.slice_from("lat"):
                return False
        elif among_var == 70:
            if not self.slice_from("et"):
                return False
        elif among_var == 71:
            if not self.slice_from("est"):
                return False
        elif among_var == 72:
            if not self.slice_from("ist"):
                return False
        elif among_var == 73:
            if not self.slice_from("kst"):
                return False
        elif among_var == 74:
            if not self.slice_from("ost"):
                return False
        elif among_var == 75:
            if not self.slice_from("išt"):
                return False
        elif among_var == 76:
            if not self.slice_from("ova"):
                return False
        elif among_var == 77:
            if not self.slice_from("av"):
                return False
        elif among_var == 78:
            if not self.slice_from("ev"):
                return False
        elif among_var == 79:
            if not self.slice_from("iv"):
                return False
        elif among_var == 80:
            if not self.slice_from("ov"):
                return False
        elif among_var == 81:
            if not self.slice_from("mov"):
                return False
        elif among_var == 82:
            if not self.slice_from("lov"):
                return False
        elif among_var == 83:
            if not self.slice_from("el"):
                return False
        elif among_var == 84:
            if not self.slice_from("anj"):
                return False
        elif among_var == 85:
            if not self.slice_from("enj"):
                return False
        elif among_var == 86:
            if not self.slice_from("šnj"):
                return False
        elif among_var == 87:
            if not self.slice_from("en"):
                return False
        elif among_var == 88:
            if not self.slice_from("šn"):
                return False
        elif among_var == 89:
            if not self.slice_from("čin"):
                return False
        elif among_var == 90:
            if not self.slice_from("roši"):
                return False
        elif among_var == 91:
            if not self.slice_from("oš"):
                return False
        elif among_var == 92:
            if not self.slice_from("evit"):
                return False
        elif among_var == 93:
            if not self.slice_from("ovit"):
                return False
        elif among_var == 94:
            if not self.slice_from("ast"):
                return False
        elif among_var == 95:
            if not self.slice_from("k"):
                return False
        elif among_var == 96:
            if not self.slice_from("eva"):
                return False
        elif among_var == 97:
            if not self.slice_from("ava"):
                return False
        elif among_var == 98:
            if not self.slice_from("iva"):
                return False
        elif among_var == 99:
            if not self.slice_from("uva"):
                return False
        elif among_var == 100:
            if not self.slice_from("ir"):
                return False
        elif among_var == 101:
            if not self.slice_from("ač"):
                return False
        elif among_var == 102:
            if not self.slice_from("ača"):
                return False
        elif among_var == 103:
            if not self.slice_from("ni"):
                return False
        elif among_var == 104:
            if not self.slice_from("a"):
                return False
        elif among_var == 105:
            if not self.slice_from("ur"):
                return False
        elif among_var == 106:
            if not self.slice_from("astaj"):
                return False
        elif among_var == 107:
            if not self.slice_from("istaj"):
                return False
        elif among_var == 108:
            if not self.slice_from("ostaj"):
                return False
        elif among_var == 109:
            if not self.slice_from("aj"):
                return False
        elif among_var == 110:
            if not self.slice_from("asta"):
                return False
        elif among_var == 111:
            if not self.slice_from("ista"):
                return False
        elif among_var == 112:
            if not self.slice_from("osta"):
                return False
        elif among_var == 113:
            if not self.slice_from("ta"):
                return False
        elif among_var == 114:
            if not self.slice_from("inj"):
                return False
        elif among_var == 115:
            if not self.slice_from("as"):
                return False
        elif among_var == 116:
            if not self.slice_from("i"):
                return False
        elif among_var == 117:
            if not self.slice_from("luč"):
                return False
        elif among_var == 118:
            if not self.slice_from("jeti"):
                return False
        elif among_var == 119:
            if not self.slice_from("e"):
                return False
            ...
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("luc"):
                return False
        elif among_var == 122:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("snj"):
                return False
        elif among_var == 123:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("os"):
                return False
        elif among_var == 124:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("ac"):
                return False
        elif among_var == 125:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("ec"):
                return False
        elif among_var == 126:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("uc"):
                return False
        elif among_var == 127:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("rosi"):
                return False
        elif among_var == 128:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("aca"):
                return False
        elif among_var == 129:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("jas"):
                return False
        elif among_var == 130:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("tas"):
                return False
        elif among_var == 131:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("gas"):
                return False
        elif among_var == 132:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("nas"):
                return False
        elif among_var == 133:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("kas"):
                return False
        elif among_var == 134:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("vas"):
                return False
        elif among_var == 135:
            if not self.B_no_diacritics:
                return False
            if not self.slice_from("bas"):
                return False
        elif among_var == 136:
            if not self.B_no_diacritics:
                return False

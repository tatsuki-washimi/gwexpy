...
from _pydevd_bundle import pydevd_vars, pydevd_xml
...
from _pydev_bundle.pydev_imports import Exec, _queue, xmlrpclib
...
class BaseInterpreterInterface:
    ...
    def build_banner(self):
        return f"print({repr(self.get_greeting_msg())})\n"

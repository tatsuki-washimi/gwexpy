...
from _pydev_bundle._pydev_saved_modules import ThreadingEvent, thread, threading, time
...
from _pydevd_bundle.pydevd_defaults import (
    PydevdCustomization,  # Note: import alias used on pydev_monkey.
)
...
from _pydevd_bundle.pydevd_net_command import NULL_NET_COMMAND, NetCommand
...
try:
    b"dummy"  # Added because otherwise Jython 2.2.1 wasn't finding the encoding (if it wasn't loaded in the main thread).
except:
    pass
...
class PyDB:
    ...
    def init_gui_support(self):
        ...
        from pydev_ipython.inputhook import enable_gui, set_return_control_callback
            ...
            if is_current_thread_main_thread():  # Only call enable_gui in the main thread.
                try:
                    ...
                    try:
                        ...
                        pydev_log.debug(f"Cannot activate custom GUI event loop {self._gui_event_loop}: {e}")
                    finally:
                        self.activate_gui_function = None

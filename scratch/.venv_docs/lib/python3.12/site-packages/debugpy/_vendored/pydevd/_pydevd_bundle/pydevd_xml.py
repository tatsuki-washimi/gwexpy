...
from _pydevd_bundle import pydevd_extension_utils, pydevd_resolver
...
from _pydevd_bundle.pydevd_resolver import MoreItems, MoreItemsRange, get_var_scope
from _pydevd_bundle.pydevd_utils import DAPGrouper, hasattr_checked, isinstance_checked

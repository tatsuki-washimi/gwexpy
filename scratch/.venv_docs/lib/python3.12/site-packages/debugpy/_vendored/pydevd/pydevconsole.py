...
"""
from _pydev_bundle._pydev_saved_modules import _code, thread
...
from _pydev_bundle.pydev_console_utils import (  # @UnusedImport
...
from _pydev_bundle.pydev_umd import _set_globals_function, runfile
...
def start_console_server(host, port, interpreter):
    try:
        ...
        from _pydev_bundle.pydev_imports import (
            SimpleXMLRPCServer as XMLRPCServer,  # @Reimport
        )

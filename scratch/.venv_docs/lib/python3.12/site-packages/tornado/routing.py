...
class Rule:
    ...
    def __repr__(self) -> str:
        return f"{self.__class__.__name__}({self.matcher!r}, {self.target}, kwargs={self.target_kwargs!r}, name={self.name!r})"
...
class URLSpec(Rule):
    ...
    def __repr__(self) -> str:
        return f"{self.__class__.__name__}({self.regex.pattern!r}, {self.handler_class}, kwargs={self.kwargs!r}, name={self.name!r})"

...
class PortScanner:
    ...
    def scan(self, hosts: str = ..., ports: Optional[str] = ..., arguments: str = ..., sudo: bool = ...) -> _Result: ...
...
def __scan_progressive__(self, hosts: str, ports: str, arguments: str, callback: Optional[_Callback], sudo: bool) -> None: ...

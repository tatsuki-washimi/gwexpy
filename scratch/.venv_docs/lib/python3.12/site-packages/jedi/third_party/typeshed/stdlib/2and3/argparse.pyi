...
class _ActionsContainer:
    ...
    def __init__(
        self, description: Optional[str], prefix_chars: str, argument_default: Any, conflict_handler: str
    ) -> None: ...
...
class HelpFormatter:
    ...
    def _join_parts(self, part_strings: Iterable[str]) -> _Text: ...
    def _format_usage(
        self, usage: str, actions: Iterable[Action], groups: Iterable[_ArgumentGroup], prefix: Optional[str]
    ) -> _Text: ...
    def _format_actions_usage(self, actions: Iterable[Action], groups: Iterable[_ArgumentGroup]) -> _Text: ...
    def _format_text(self, text: str) -> _Text: ...
    def _format_action(self, action: Action) -> _Text: ...
    def _format_action_invocation(self, action: Action) -> _Text: ...
    def _metavar_formatter(self, action: Action, default_metavar: str) -> Callable[[int], tuple[_Text, ...]]: ...
    def _format_args(self, action: Action, default_metavar: str) -> _Text: ...
    def _expand_help(self, action: Action) -> _Text: ...
    def _iter_indented_subactions(self, action: Action) -> Generator[Action]: ...
    def _split_lines(self, text: str, width: int) -> list[_Text]: ...
    def _fill_text(self, text: str, width: int, indent: str) -> _Text: ...
...
class _HelpAction(Action):
    def __init__(
        self, option_strings: Sequence[str], dest: str = ..., default: str = ..., help: Optional[str] = ...
    ) -> None: ...

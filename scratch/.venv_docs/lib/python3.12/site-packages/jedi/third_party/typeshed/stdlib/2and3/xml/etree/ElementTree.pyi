...
_parser_input_type = Union[bytes, str]
...
_str_argument_type = Union[str, str]
...
class Element(MutableSequence[Element]):
    ...
    def iter(self, tag: Optional[_str_argument_type] = ...) -> Generator[Element]: ...
    def iterfind(
        self, path: _str_argument_type, namespaces: Optional[dict[_str_argument_type, _str_argument_type]] = ...
    ) -> list[Element]: ...
    def itertext(self) -> Generator[_str_result_type]: ...

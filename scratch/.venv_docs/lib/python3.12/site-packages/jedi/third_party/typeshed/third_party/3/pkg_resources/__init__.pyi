...
_DistFinderType = Callable[[_Importer, str, bool], Generator[Distribution]]
...
class WorkingSet:
    ...
    def iter_entry_points(self, group: str, name: Optional[str] = ...) -> Generator[EntryPoint]: ...
    def add_entry(self, entry: str) -> None: ...
    def __contains__(self, dist: Distribution) -> bool: ...
    def __iter__(self) -> Generator[Distribution]: ...
...
def iter_entry_points(group: str, name: Optional[str] = ...) -> Generator[EntryPoint]: ...
...
def parse_requirements(strs: Union[str, Iterable[str]]) -> Generator[Requirement]: ...
...
def find_distributions(path_item: str, only: bool = ...) -> Generator[Distribution]: ...
...
class IMetadataProvider:
    ...
    def get_metadata_lines(self, name: str) -> Generator[str]: ...
...
def yield_lines(strs: _NestedStr) -> Generator[str]: ...
def split_sections(strs: _NestedStr) -> Generator[tuple[Optional[str], str]]: ...

...
class TarFile(Iterable[TarInfo]):
    ...
    def getmembers(self) -> builtins.list[TarInfo]: ...
    def getnames(self) -> builtins.list[str]: ...
    if sys.version_info >= (3, 5):
        def list(self, verbose: bool = ..., *, members: Optional[builtins.list[TarInfo]] = ...) -> None: ...
    else:
        def list(self, verbose: bool = ...) -> None: ...
    def next(self) -> Optional[TarInfo]: ...
    if sys.version_info >= (3, 5):
        def extractall(
            self, path: AnyPath = ..., members: Optional[builtins.list[TarInfo]] = ..., *, numeric_owner: bool = ...
        ) -> None: ...
    else:
        def extractall(self, path: AnyPath = ..., members: Optional[builtins.list[TarInfo]] = ...) -> None: ...
    if sys.version_info >= (3, 5):
        def extract(

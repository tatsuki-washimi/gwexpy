...
class FTP:
    ...
    if sys.version_info >= (3, 3):
        ...
        def __init__(
            self, host: str = ..., user: str = ..., passwd: str = ..., acct: str = ..., timeout: float = ...
        ) -> None: ...
    ...
    def ntransfercmd(self, cmd: str, rest: Optional[_IntOrStr] = ...) -> tuple[socket, int]: ...
    def transfercmd(self, cmd: str, rest: Optional[_IntOrStr] = ...) -> socket: ...
    def retrbinary(
        self, cmd: str, callback: Callable[[bytes], Any], blocksize: int = ..., rest: Optional[_IntOrStr] = ...
    ) -> str: ...
    def storbinary(
        self,
        cmd: str,

...
_FileObj = Union[str, str, IO[str], IO[str]]
...
class tzfile(_tzinfo):
    def __init__(self, fileobj: _FileObj, filename: Optional[str] = ...) -> None: ...
...
class _GetTZ:
    def __call__(self, name: Optional[str] = ...) -> Optional[datetime.tzinfo]: ...
    def nocache(self, name: Optional[str]) -> Optional[datetime.tzinfo]: ...

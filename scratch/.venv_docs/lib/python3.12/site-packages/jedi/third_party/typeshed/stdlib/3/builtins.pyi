...
class object:
    ...
    __module__: str
    __annotations__: builtins.dict[str, Any]
    @property
...
class type:
    ...
    @classmethod
    def __prepare__(metacls, __name: str, __bases: builtins.tuple[type, ...], **kwds: Any) -> Mapping[str, Any]: ...
...
class int:
    @overload
    def __new__(cls: builtins.type[_T], x: Union[str, bytes, SupportsInt, _SupportsIndex, _SupportsTrunc] = ...) -> _T: ...
    @overload
    def __new__(cls: builtins.type[_T], x: Union[str, bytes, bytearray], base: int) -> _T: ...
    @overload
    ...
    if sys.version_info >= (3, 8):
        def as_integer_ratio(self) -> builtins.tuple[int, Literal[1]]: ...
    @property
    def real(self) -> int: ...
    @property
    def imag(self) -> int: ...
...
class float:
    def __new__(cls: builtins.type[_T], x: Union[SupportsFloat, _SupportsIndex, str, bytes, bytearray] = ...) -> _T: ...
...
class str(Sequence[str]):
    @overload
    def __new__(cls: builtins.type[_T], o: object = ...) -> _T: ...
    @overload
    def __new__(cls: builtins.type[_T], o: bytes, encoding: str = ..., errors: str = ...) -> _T: ...
    @overload
    ...
    def endswith(self, suffix: Union[str, builtins.tuple[str, ...]], start: Optional[int] = ..., end: Optional[int] = ...) -> bool: ...
    ...
    def startswith(self, prefix: Union[str, builtins.tuple[str, ...]], start: Optional[int] = ..., end: Optional[int] = ...) -> bool: ...
    ...
    @staticmethod
    @overload
    def maketrans(__x: Union[builtins.dict[int, _T], builtins.dict[str, _T], builtins.dict[Union[str, int], _T]]) -> builtins.dict[int, _T]: ...
    @staticmethod
    @overload
    def maketrans(__x: str, __y: str, __z: Optional[str] = ...) -> builtins.dict[int, Union[int, None]]: ...
...
class bytes(ByteString):
    @overload
    def __new__(cls: builtins.type[_T], ints: Iterable[int]) -> _T: ...
    @overload
    def __new__(cls: builtins.type[_T], string: str, encoding: str, errors: str = ...) -> _T: ...
    @overload
    def __new__(cls: builtins.type[_T], length: int) -> _T: ...
    @overload
    def __new__(cls: builtins.type[_T]) -> _T: ...
    @overload
    def __new__(cls: builtins.type[_T], o: SupportsBytes) -> _T: ...
    ...
    def endswith(self, suffix: Union[bytes, builtins.tuple[bytes, ...]]) -> bool: ...
    ...
    def partition(self, __sep: bytes) -> builtins.tuple[bytes, bytes, bytes]: ...
    ...
    def rpartition(self, __sep: bytes) -> builtins.tuple[bytes, bytes, bytes]: ...
    def rsplit(self, sep: Optional[bytes] = ..., maxsplit: int = ...) -> builtins.list[bytes]: ...
    def rstrip(self, __bytes: Optional[bytes] = ...) -> bytes: ...
    def split(self, sep: Optional[bytes] = ..., maxsplit: int = ...) -> builtins.list[bytes]: ...
    def splitlines(self, keepends: bool = ...) -> builtins.list[bytes]: ...
    def startswith(
        self, prefix: Union[bytes, builtins.tuple[bytes, ...]], start: Optional[int] = ..., end: Optional[int] = ...
    ) -> bool: ...
    ...
    def __getnewargs__(self) -> builtins.tuple[bytes]: ...
...
class memoryview(Sized, Container[int]):
    ...
    def __exit__(
        self, exc_type: Optional[builtins.type[BaseException]], exc_val: Optional[BaseException], exc_tb: Optional[TracebackType]
    ) -> None: ...
    def cast(self, format: str, shape: Union[builtins.list[int], builtins.tuple[int]] = ...) -> memoryview: ...
    @overload
    def __getitem__(self, i: int) -> int: ...
    @overload
...
class list(MutableSequence[_T], Generic[_T]):
    ...
    def clear(self) -> None: ...
    def copy(self) -> builtins.list[_T]: ...
    ...
    @overload
    def sort(self: builtins.list[SupportsLessThanT], *, key: None = ..., reverse: bool = ...) -> None: ...
    @overload
...
class dict(MutableMapping[_KT, _VT], Generic[_KT, _VT]):
    ...
    if sys.version_info >= (3, 9):
        def __class_getitem__(cls, item: Any) -> GenericAlias: ...
        def __or__(self, __value: Mapping[_KT, _VT]) -> builtins.dict[_KT, _VT]: ...
        def __ior__(self, __value: Mapping[_KT, _VT]) -> builtins.dict[_KT, _VT]: ...
...
class enumerate(Iterator[builtins.tuple[int, _T]], Generic[_T]):
    ...
    def __next__(self) -> builtins.tuple[int, _T]: ...
    if sys.version_info >= (3, 9):
        def __class_getitem__(cls, item: Any) -> GenericAlias: ...
...
def eval(
    __source: Union[str, bytes, CodeType], __globals: Optional[builtins.dict[str, Any]] = ..., __locals: Optional[Mapping[str, Any]] = ...
) -> Any: ...
def exec(
    __source: Union[str, bytes, CodeType],
    __globals: Optional[builtins.dict[str, Any]] = ...,
...
@overload
def sorted(__iterable: Iterable[SupportsLessThanT], *, key: None = ..., reverse: bool = ...) -> builtins.list[SupportsLessThanT]: ...
@overload
def sorted(__iterable: Iterable[_T], *, key: Callable[[_T], SupportsLessThan], reverse: bool = ...) -> builtins.list[_T]: ...
...
@overload
def zip(__iter1: Iterable[_T1]) -> Iterator[builtins.tuple[_T1]]: ...
@overload
def zip(__iter1: Iterable[_T1], __iter2: Iterable[_T2]) -> Iterator[builtins.tuple[_T1, _T2]]: ...
@overload
def zip(__iter1: Iterable[_T1], __iter2: Iterable[_T2], __iter3: Iterable[_T3]) -> Iterator[builtins.tuple[_T1, _T2, _T3]]: ...
@overload
def zip(
    __iter1: Iterable[_T1], __iter2: Iterable[_T2], __iter3: Iterable[_T3], __iter4: Iterable[_T4]
) -> Iterator[builtins.tuple[_T1, _T2, _T3, _T4]]: ...
@overload
def zip(
    __iter1: Iterable[_T1], __iter2: Iterable[_T2], __iter3: Iterable[_T3], __iter4: Iterable[_T4], __iter5: Iterable[_T5]
) -> Iterator[builtins.tuple[_T1, _T2, _T3, _T4, _T5]]: ...
@overload
def zip(
    __iter1: Iterable[Any],
    __iter2: Iterable[Any],

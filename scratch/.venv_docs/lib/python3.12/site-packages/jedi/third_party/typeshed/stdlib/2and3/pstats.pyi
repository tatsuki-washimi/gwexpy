...
class Stats:
    ...
    def __init__(
        self: _T,
        __arg: Union[None, str, str, Profile, _cProfile] = ...,
        *args: Union[None, str, str, Profile, _cProfile, _T],
        stream: Optional[IO[Any]] = ...,
    ) -> None: ...
    def init(self, arg: Union[None, str, str, Profile, _cProfile]) -> None: ...
    def load_stats(self, arg: Union[None, str, str, Profile, _cProfile]) -> None: ...
    def get_top_level_stats(self) -> None: ...
    def add(self: _T, *arg_list: Union[None, str, str, Profile, _cProfile, _T]) -> _T: ...

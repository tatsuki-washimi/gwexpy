...
class S3Connection(AWSAuthConnection):
    ...
    def get_all_buckets(self, headers: Optional[dict[str, str]] = ...): ...
    def get_canonical_user_id(self, headers: Optional[dict[str, str]] = ...): ...
    def get_bucket(self, bucket_name: str, validate: bool = ..., headers: Optional[dict[str, str]] = ...) -> Bucket: ...
    def head_bucket(self, bucket_name, headers: Optional[dict[str, str]] = ...): ...
    def lookup(self, bucket_name, validate: bool = ..., headers: Optional[dict[str, str]] = ...): ...
    def create_bucket(
        self, bucket_name, headers: Optional[dict[str, str]] = ..., location: Any = ..., policy: Optional[Any] = ...
    ): ...
    def delete_bucket(self, bucket, headers: Optional[dict[str, str]] = ...): ...

...
if sys.version_info < (3, 8):
    ...
    if sys.version_info < (3, 0):
        ...
        @overload
        def join(__p1: bytes, __p2: bytes, __p3: bytes, __p4: str, *p: AnyPath) -> str: ...
        @overload
        def join(__p1: bytes, __p2: bytes, __p3: str, *p: AnyPath) -> str: ...
        @overload
        def join(__p1: bytes, __p2: str, *p: AnyPath) -> str: ...
        @overload
        def join(__p1: str, *p: AnyPath) -> str: ...

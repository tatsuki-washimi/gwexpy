...
class Encoder:
    ...
    def encode(self, value: Union[str, bytes, memoryview, bool, float]) -> bytes: ...
    def decode(self, value: Union[str, bytes, memoryview], force: bool = ...) -> str: ...
...
class ConnectionPool:
    @classmethod
    def from_url(cls, url: str, db: Optional[int] = ..., decode_components: bool = ..., **kwargs) -> ConnectionPool: ...

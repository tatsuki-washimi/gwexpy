...
def execl(file: AnyPath, __arg0: Union[bytes, str], *args: Union[bytes, str]) -> NoReturn: ...
def execlp(file: AnyPath, __arg0: Union[bytes, str], *args: Union[bytes, str]) -> NoReturn: ...

# These are: execle(file, *args, env) but env is pulled from the last element of the args.
def execle(file: AnyPath, __arg0: Union[bytes, str], *args: Any) -> NoReturn: ...
def execlpe(file: AnyPath, __arg0: Union[bytes, str], *args: Any) -> NoReturn: ...

# The docs say `args: tuple or list of strings`
# The implementation enforces tuple or list so we can't use Sequence.
_ExecVArgs = Union[tuple[Union[bytes, str], ...], list[bytes], list[str], list[Union[bytes, str]]]
...
def spawnl(mode: int, path: AnyPath, arg0: Union[bytes, str], *args: Union[bytes, str]) -> int: ...
def spawnle(mode: int, path: AnyPath, arg0: Union[bytes, str], *args: Any) -> int: ...  # Imprecise sig
def spawnv(mode: int, path: AnyPath, args: list[Union[bytes, str]]) -> int: ...
def spawnve(mode: int, path: AnyPath, args: list[Union[bytes, str]], env: Mapping[str, str]) -> int: ...
...
if sys.platform == "win32":
    ...
    # Unix only
    def spawnlp(mode: int, file: AnyPath, arg0: Union[bytes, str], *args: Union[bytes, str]) -> int: ...
    def spawnlpe(mode: int, file: AnyPath, arg0: Union[bytes, str], *args: Any) -> int: ...  # Imprecise signature
    def spawnvp(mode: int, file: AnyPath, args: list[Union[bytes, str]]) -> int: ...
    def spawnvpe(mode: int, file: AnyPath, args: list[Union[bytes, str]], env: Mapping[str, str]) -> int: ...

...
class croniter(Iterator[Any]):
    ...
    def __init__(
        self, expr_format: str, start_time: Optional[Union[float, datetime.datetime]] = ..., ret_type: Optional[_RetType] = ...
    ) -> None: ...
    ...
    @classmethod
    def expand(cls, expr_format: str) -> tuple[list[list[str]], dict[str, Any]]: ...
    @classmethod

...
class Redis(Generic[_StrType]):
    ...
    def acl_cat(self, category: Optional[str] = ...) -> list[str]: ...
    def acl_deluser(self, username: str) -> int: ...
    def acl_genpass(self) -> str: ...
    def acl_getuser(self, username: str) -> Optional[Any]: ...
    ...
    def acl_setuser(
        ...
        hashed_passwords: Optional[Sequence[str]] = ...,
    ...
    def scan_iter(self, match: Optional[str] = ..., count: Optional[int] = ...) -> Iterator[_StrType]: ...
    ...
    def sinter(self, keys: _Key, *args: _Key) -> builtins.set[_Value]: ...
    def sinterstore(self, dest, keys, *args): ...
    def sismember(self, name: _Key, value: _Value) -> bool: ...
    def smembers(self, name: _Key) -> builtins.set[_Value]: ...
    ...
    def register_script(self, script: Union[str, _StrType]) -> Script: ...

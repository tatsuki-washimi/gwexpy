...
class MetaTable:
    ...
    def get_index_hash_keyname(self, index_name: str) -> Optional[str]: ...
...
class Connection:
    ...
    @property
    def client(self): ...
    def get_meta_table(self, table_name: str, refresh: bool = ...): ...
    def create_table(
        self,
        table_name: str,
    ...
    def get_item_attribute_map(self, table_name: str, attributes, item_key: Any = ..., pythonic_key: bool = ...): ...
    def get_expected_map(self, table_name: str, expected): ...
    def parse_attribute(self, attribute, return_type: bool = ...): ...
    def get_attribute_type(self, table_name: str, attribute_name, value: Optional[Any] = ...): ...
    def get_identifier_map(self, table_name: str, hash_key, range_key: Optional[Any] = ..., key: Any = ...): ...
    def get_query_filter_map(self, table_name: str, query_filters): ...
    ...
    def get_exclusive_start_key_map(self, table_name: str, exclusive_start_key): ...
    def delete_item(
        self,
        table_name: str,
        hash_key,

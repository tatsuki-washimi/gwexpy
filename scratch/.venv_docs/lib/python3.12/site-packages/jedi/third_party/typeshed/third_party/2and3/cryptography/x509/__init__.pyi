...
class RelativeDistinguishedName:
    ...
    def __iter__(self) -> Generator[NameAttribute]: ...
...
class Extensions:
    ...
    def __iter__(self) -> Generator[Extension[Any]]: ...
...
class IssuerAlternativeName(ExtensionType):
    ...
    def __iter__(self) -> Generator[GeneralName]: ...
...
class AuthorityInformationAccess(ExtensionType):
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> Generator[AccessDescription]: ...
...
class ExtendedKeyUsage(ExtensionType):
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> Generator[ObjectIdentifier]: ...

...
class BaseRequest:
    ...
    @overload
    def get_data(self, cache: bool, as_text: Literal[True], parse_form_data: bool = ...) -> str: ...
    @overload
    def get_data(self, *, as_text: Literal[True], parse_form_data: bool = ...) -> str: ...
    @overload
...
class BaseResponse:
    ...
    def __init__(
        ...
        headers: Optional[Union[Headers, Mapping[str, str], Sequence[tuple[str, str]]]] = ...,
    ...
    @overload
    def get_data(self, as_text: Literal[True]) -> str: ...
    @overload
    def get_data(self, as_text: bool) -> Any: ...
    def set_data(self, value: Union[bytes, str]) -> None: ...
    data: Any

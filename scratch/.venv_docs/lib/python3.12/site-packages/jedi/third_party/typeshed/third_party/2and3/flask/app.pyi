...
_WSGICallable = Callable[[dict[str, Any], _StartResponse], Iterable[bytes]]

_Status = Union[str, int]
_Headers = Union[dict[Any, Any], list[tuple[Any, Any]]]
_Body = Union[str, ByteString, dict[str, Any], Response, _WSGICallable]
...
class Flask(_PackageBoundObject):
    ...
    import_name: str = ...
    template_folder: str = ...
    root_path: Union[str, str] = ...
    static_url_path: Any = ...
    static_folder: Optional[str] = ...
    instance_path: Union[str, str] = ...
    config: Config = ...
    view_functions: Any = ...
    ...
    def open_instance_resource(self, resource: Union[str, str], mode: str = ...): ...

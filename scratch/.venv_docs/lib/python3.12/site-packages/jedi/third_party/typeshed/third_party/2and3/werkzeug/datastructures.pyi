from collections.abc import Callable, Container, Iterable, Iterator, Mapping, MutableSet
from typing import (
    IO,
    Any,
    Generic,
...
class FileStorage:
    ...
    def save(self, dst: Union[str, SupportsWrite[bytes]], buffer_size: int = ...): ...
    def close(self) -> None: ...

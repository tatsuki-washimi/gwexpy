...
class TestCase(Testable):
    ...
    def assertRegexpMatches(self, text: str, regexp: _Regexp, msg: object = ...) -> None: ...
    def assertNotRegexpMatches(self, text: str, regexp: _Regexp, msg: object = ...) -> None: ...

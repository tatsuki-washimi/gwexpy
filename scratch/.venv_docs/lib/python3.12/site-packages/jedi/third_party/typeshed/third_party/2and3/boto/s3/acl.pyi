...
class Policy:
    ...
    owner: User
    def startElement(self, name: str, attrs: dict[str, Any], connection: S3Connection) -> Union[None, User, ACL]: ...
...
class ACL:
    ...
    def add_user_grant(self, permission: str, user_id: str, display_name: Optional[str] = ...) -> None: ...

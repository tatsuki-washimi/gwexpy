...
class Environment:
    ...
    def preprocess(self, source: str, name: Optional[Any] = ..., filename: Optional[Any] = ...): ...
    def compile(
        self, source, name: Optional[Any] = ..., filename: Optional[Any] = ..., raw: bool = ..., defer_init: bool = ...
    ): ...
    def compile_expression(self, source: str, undefined_to_none: bool = ...): ...
    ...
    def join_path(self, template: Union[Template, str], parent: str) -> str: ...
    def get_template(
        self, name: Union[Template, str], parent: Optional[str] = ..., globals: Optional[Any] = ...
    ) -> Template: ...
    def select_template(
        self, names: Sequence[Union[Template, str]], parent: Optional[str] = ..., globals: Optional[dict[str, Any]] = ...
    ) -> Template: ...
    def get_or_select_template(
        self,
        template_name_or_list: Union[Union[Template, str], Sequence[Union[Template, str]]],
        parent: Optional[str] = ...,
        globals: Optional[dict[str, Any]] = ...,
    ) -> Template: ...
    def from_string(
        self, source: str, globals: Optional[dict[str, Any]] = ..., template_class: Optional[type[Template]] = ...
    ) -> Template: ...
...
class Template:
    ...
    def generate(self, *args, **kwargs) -> Iterator[str]: ...
    def new_context(
    ...
    def debug_info(self): ...
    if sys.version_info >= (3, 6):
        def render_async(self, *args, **kwargs) -> Awaitable[str]: ...
        def generate_async(self, *args, **kwargs) -> AsyncIterator[str]: ...
...
class TemplateStream:
    ...
    def dump(self, fp, encoding: Optional[str] = ..., errors: str = ...): ...
    buffered: bool

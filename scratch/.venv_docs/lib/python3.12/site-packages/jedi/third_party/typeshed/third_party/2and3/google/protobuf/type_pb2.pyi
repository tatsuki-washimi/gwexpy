...
isort:skip_file
"""
from collections.abc import Iterable as typing___Iterable
from typing import Literal as typing_extensions___Literal
from typing import (
...
class Type(google___protobuf___message___Message):
    ...
    name: str = ...
    oneofs: google___protobuf___internal___containers___RepeatedScalarFieldContainer[str] = ...
    ...
    def __init__(self,
        *,
        name : typing___Optional[str] = None,
        fields : typing___Optional[typing___Iterable[type___Field]] = None,
        oneofs : typing___Optional[typing___Iterable[str]] = None,
    ...
    def HasField(self, field_name: typing_extensions___Literal["source_context",b"source_context"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal["fields",b"fields","name",b"name","oneofs",b"oneofs","options",b"options","source_context",b"source_context","syntax",b"syntax"]) -> None: ...
type___Type = Type
...
class Field(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        ...
        name : typing___Optional[str] = None,
        type_url : typing___Optional[str] = None,
        oneof_index : typing___Optional[builtin___int] = None,
        packed : typing___Optional[builtin___bool] = None,
        options : typing___Optional[typing___Iterable[type___Option]] = None,
        json_name : typing___Optional[str] = None,
        default_value : typing___Optional[str] = None,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal["cardinality",b"cardinality","default_value",b"default_value","json_name",b"json_name","kind",b"kind","name",b"name","number",b"number","oneof_index",b"oneof_index","options",b"options","packed",b"packed","type_url",b"type_url"]) -> None: ...
type___Field = Field
...
class Enum(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal["source_context",b"source_context"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal["enumvalue",b"enumvalue","name",b"name","options",b"options","source_context",b"source_context","syntax",b"syntax"]) -> None: ...
type___Enum = Enum
...
class EnumValue(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal["name",b"name","number",b"number","options",b"options"]) -> None: ...
...
class Option(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal["name",b"name","value",b"value"]) -> None: ...

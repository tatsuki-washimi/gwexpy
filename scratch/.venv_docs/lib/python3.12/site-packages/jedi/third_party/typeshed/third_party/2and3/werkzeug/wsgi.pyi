...
def get_path_info(environ, charset: str = ..., errors: str = ...): ...
def get_script_name(environ, charset: str = ..., errors: str = ...): ...
def pop_path_info(environ, charset: str = ..., errors: str = ...): ...
def peek_path_info(environ, charset: str = ..., errors: str = ...): ...
def extract_path_info(
    environ_or_baseurl, path_or_url, charset: str = ..., errors: str = ..., collapse_http_schemes: bool = ...
): ...

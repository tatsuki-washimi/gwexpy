...
from jedi.inference.base_value import NO_VALUES, ValueSet, iterator_to_value_set
...
def _execute_array_values(inference_state, array):
    ...
    """
    from jedi.inference.value.iterable import FakeList, FakeTuple, SequenceLiteralValue

...
InspiralSICoincDef = lsctables.CoincDef(search = "inspiral", search_coinc_type = 1, description = "sim_inspiral<-->sngl_inspiral coincidences")
InspiralSCNearCoincDef = lsctables.CoincDef(search = "inspiral", search_coinc_type = 2, description = "sim_inspiral<-->coinc_event coincidences (nearby)")
InspiralSCExactCoincDef = lsctables.CoincDef(search = "inspiral", search_coinc_type = 3, description = "sim_inspiral<-->coinc_event coincidences (exact)")
InspiralSTCoincDef = lsctables.CoincDef(search = "inspiral", search_coinc_type = 4, description = "sim_inspiral<-->sngl_inspiral template coincidences")

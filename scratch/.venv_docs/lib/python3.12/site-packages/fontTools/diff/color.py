...
green_start: str = ansicolors["GREEN"]
red_start: str = ansicolors["RED"]
cyan_start: str = ansicolors["CYAN"]
reset: str = ansicolors["RESET"]


def color_unified_diff_line(line: str) -> str:

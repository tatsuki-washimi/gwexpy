...
def summarize(
    ...
    with (
        ...
        lines.append("Binary table summary:\n")
...
def run(argv: list[str]):
    ...
    include_list: Optional[list[str]] = get_tables_argument_list(args.include)
    exclude_list: Optional[list[str]] = get_tables_argument_list(args.exclude)

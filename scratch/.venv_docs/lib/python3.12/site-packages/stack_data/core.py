...
class Line:
    ...
    def __repr__(self):
        return f"<{self.__class__.__name__} {self.lineno} (current={self.is_current}) " \
               f"{self.text!r} of {self.frame_info.filename}>"
...
class RepeatedFrames:
    ...
    def description(self) -> str:
        ...
        return ', '.join(
            f'{Source.for_filename(code.co_filename).code_qualname(code)} at line {lineno} ({count} times)'

...
from iminuit.typing import Cost, CostVector, UserBound
...
class Minuit:
    ...
    def mnprofile(
        ...
        *,
        ...
        r"""Get Minos profile over a specified interval.
    ...
    def draw_mnprofile(
        ...
        r"""Draw Minos profile over a specified interval (requires matplotlib).
    ...
    def profile(
        ...
        *,
        ...
        r"""Calculate 1D cost function profile over a range.
            ...
            plt.title(
                (
                    ...
                    if vmin is None
                        ...
                        f"{pname} = {v:.3g} - {v - vmin:.3g} + {vmax - v:.3g}"
                    )
                ),
                fontsize="large",
            )
    ...
    def contour(
        ...
        *,
        ...
        r"""Get a 2D contour of the function around the minimum.

...
class EMDTest(unittest.TestCase):
    ...
    def test_emd_passArgsViaDict(self):
        ...
        emd = EMD()
        self.assertFalse(emd.FIXE == FIXE, f"{emd.FIXE} == {FIXE}")

        # Second: test with passing
        emd = EMD(**params)
        self.assertTrue(emd.FIXE == FIXE, f"{emd.FIXE} == {FIXE}")
    ...
    def test_emd_passImplicitParamsDirectly(self):
        ...
        self.assertTrue(emd.FIXE == FIXE, f"{emd.FIXE} == {FIXE}")
        self.assertTrue(emd.svar_thr == svar_thr, f"{emd.svar_thr} == {svar_thr}")

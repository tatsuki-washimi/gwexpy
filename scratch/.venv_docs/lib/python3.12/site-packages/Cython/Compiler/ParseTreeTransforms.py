...
from . import Builtin, Code, Errors, ExprNodes, Naming, Nodes, Options, PyrexTypes
from .Errors import CompileError, InternalError, error, warning
...
class TransformBuiltinMethods(EnvTransform):
    ...
    def visit_NameNode(self, node):
        if node.name == '__class__':
            ...
            entry = lenv.lookup_here('__class__')
            if not entry:

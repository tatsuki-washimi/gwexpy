...
from . import Builtin, ExprNodes, Naming, Nodes, PyrexTypes
from .Code import PyxCodeWriter, UtilityCode
        ...
        if name in default_value_assignments:
            ...
            if (isinstance(assignment, ExprNodes.CallNode) and (
                ...
                if assignment.type in [Builtin.list_type, Builtin.dict_type, Builtin.set_type]:
                    ...
                    error(assignment.pos, f"mutable default <class '{assignment.type.name}'> for field {name} is not allowed: "
                          "use default_factory")

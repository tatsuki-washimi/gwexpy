...
from . import Errors, ExprNodes, Naming, ParseTreeTransforms, PyrexTypes, StringEncoding
from .Errors import CannotSpecialize, error
from .ExprNodes import CloneNode, CodeObjectNode, ProxyNode, TupleNode
from .Nodes import DefNode, FuncDefNode, StatListNode
...
class FusedCFuncDefNode(StatListNode):
    ...
    def make_fused_cpdef(self, orig_py_func, env, is_def):
        ...
        """
        from . import Code, TreeFragment, UtilityCode

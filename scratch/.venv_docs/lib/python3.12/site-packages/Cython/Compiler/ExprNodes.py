...
from .DebugFlags import debug_coercion, debug_disposal_code
from .Errors import (
    CannotSpecialize,
    CompileError,
    InternalError,
    ...
    def generate_operation_code(self, code):
        if self.type.is_pyobject:
            ...
            if self.mult_factor:
                ...
                code.putln(f"for ({Naming.quick_temp_cname} = 0; {Naming.quick_temp_cname} < {self.mult_factor.result()}; {Naming.quick_temp_cname}++) {{")

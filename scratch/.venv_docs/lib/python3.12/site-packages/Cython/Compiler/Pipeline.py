...
from . import DebugFlags, Errors, Naming, Options
from .Errors import AbortError, CompileError, InternalError
...
def create_pipeline(context, mode, exclude_classes=()):
    ...
    from .TypeInference import MarkOverflowingArithmetic, MarkParallelAssignments

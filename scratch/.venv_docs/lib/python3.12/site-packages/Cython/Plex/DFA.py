...
if cython.compiled:
    from cython.cimports.Cython.Plex.Machines import FastMachine, Node
    from cython.cimports.Cython.Plex.Transitions import (
        TransitionMap as type_TransitionMap,
    )
else:
    from Cython.Plex.Machines import FastMachine, Node

...
class KernelManager(ConnectionFileMixin):
    ...
    @observe_compat
    def _kernel_spec_manager_changed(self, change: dict[str, Instance]) -> None:
    ...
    @observe("kernel_name")
    def _kernel_name_changed(self, change: dict[str, str]) -> None:
        self._kernel_spec = None
    ...
    async def _async_launch_kernel(self, kernel_cmd: list[str], **kw: t.Any) -> None:

...
class KernelClient(ConnectionFileMixin):
    ...
    * control: for kernel management calls to the kernel.
    ...
    async def _async_get_shell_msg(self, *args: t.Any, **kwargs: t.Any) -> dict[str, t.Any]:
        """Get a message from the shell channel"""
        return await ensure_async(self.shell_channel.get_msg(*args, **kwargs))

    async def _async_get_iopub_msg(self, *args: t.Any, **kwargs: t.Any) -> dict[str, t.Any]:
        """Get a message from the iopub channel"""
        return await ensure_async(self.iopub_channel.get_msg(*args, **kwargs))

    async def _async_get_stdin_msg(self, *args: t.Any, **kwargs: t.Any) -> dict[str, t.Any]:
        """Get a message from the stdin channel"""
        return await ensure_async(self.stdin_channel.get_msg(*args, **kwargs))

    async def _async_get_control_msg(self, *args: t.Any, **kwargs: t.Any) -> dict[str, t.Any]:
    ...
    async def _stdin_hook_default(self, msg: dict[str, t.Any]) -> None:

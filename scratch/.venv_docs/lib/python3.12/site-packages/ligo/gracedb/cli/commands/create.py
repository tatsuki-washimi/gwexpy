    ...
    def add_custom_arguments(self, parser):
        parser.add_argument(
            ...
            help=("Name of EM MOU group making the observation "
                  f"(do '{self.base_prog} info emgroups' to see options)")
    ...
    def add_custom_arguments(self, parser):
        parser.add_argument(
            ...
            help=("Analysis group which identified the event "
                  f"(do '{self.base_prog} info groups' to see options)")
        ...
        parser.add_argument(
            ...
            help=("Analysis pipeline which identified the event "
                  f"(do '{self.base_prog} info pipelines' to see options)")
        ...
        parser.add_argument(
            ...
            type=str,
            nargs='?',
            help=(f"Search type (do '{self.base_prog} info searches' to see "
                  "options)")
        )
        parser.add_argument(
            "--labels",
...
class CreateSignoffCommand(CreateChildBase):
    ...
    def add_custom_arguments(self, parser):
        parser.add_argument(
            "signoff_type",
            type=str,
            help=(f"Signoff type (do '{self.base_prog} info signoff_types') to see "
                  "options")
        )
        parser.add_argument(
            "signoff_status",
            type=str,
            help=(f"Signoff type (do '{self.base_prog} info signoff_statuses') to see "
                  "options")
        )
        parser.add_argument(
            "comment",
        ...
        parser.add_argument(
            ...
            type=str,
            nargs='?',
            help=(f"Instrument code (do '{self.base_prog} info instruments' to see "
...
class CreateSupereventCommand(CreateChildBase):
    ...
    def add_custom_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="production",
            help=(f"Superevent category (do '{self.base_prog} info superevent_categories "
                  "to see options'")
        )
        parser.add_argument(
            "--events",
...
class CreateVoeventCommand(CreateChildBase):
    ...
    def add_custom_arguments(self, parser):
        parser.add_argument(
            "voevent_type",
            type=str,
            help=(f"VOEvent type (do '{self.base_prog} info voevent_types to"
                  "see options'")
        )
        parser.add_argument(
            "--skymap-type",

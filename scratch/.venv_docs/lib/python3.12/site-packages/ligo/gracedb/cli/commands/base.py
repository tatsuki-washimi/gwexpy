...
class CommandBase:
    ...
    def __init__(self, base_prog=None, parent_prog=None):
        ...
        # Set up epilog
        parser.epilog = (f"\n\nUse '{parser.prog} <command> --help' to read about a "
                         "specific command.")
    ...
    def parse_args(self, args):
        ...
        try:
            ...
            # Command not found
            error_str = (f"Command '{self.parser.prog} {main_args.command}' not found. Do "
                         f"'{self.parser.prog} --help' to see available commands.\n")
            print(error_str)
            sys.exit(1)

...
class Character(RegexBase):
    ...
    def dump(self, indent, reverse):
        ...
        print(f"{INDENT * indent}CHARACTER {POS_TEXT[self.positive]} {display}{CASE_TEXT[self.case_flags]}")
...
class GreedyRepeat(RegexBase):
    ...
    def dump(self, indent, reverse):
        ...
        print(f"{INDENT * indent}{self._op_name} {self.min_count} {limit}")
...
class PossessiveRepeat(GreedyRepeat):
    ...
    def dump(self, indent, reverse):
        ...
        if self.max_count is None:
            ...
            limit = self.max_count
        print(f"{INDENT * (indent + 1)}{self._op_name} {self.min_count} {limit}")
...
class LookAround(RegexBase):
    ...
    def dump(self, indent, reverse):
        print(f"{INDENT * indent}LOOK{self._dir_text[self.behind]} {POS_TEXT[self.positive]}")
...
class LookAroundConditional(RegexBase):
    ...
    def dump(self, indent, reverse):
        print(f"{INDENT * indent}CONDITIONAL {self._dir_text[self.behind]} {POS_TEXT[self.positive]}")
        self.subpattern.dump(indent + 1, self.behind)
...
class Range(RegexBase):
    ...
    def dump(self, indent, reverse):
        ...
        print(f"{INDENT * indent}RANGE {POS_TEXT[self.positive]} {display_lower} {display_upper}{CASE_TEXT[self.case_flags]}")
...
class RefGroup(RegexBase):
    ...
    def dump(self, indent, reverse):
        print(f"{INDENT * indent}REF_GROUP {self.group}{CASE_TEXT[self.case_flags]}")
...
class SetBase(RegexBase):
    ...
    def dump(self, indent, reverse):
        print(f"{INDENT * indent}{self._op_name} {POS_TEXT[self.positive]}{CASE_TEXT[self.case_flags]}")
        for i in self.items:
...
class String(RegexBase):
    ...
    def dump(self, indent, reverse):
        ...
        print(f"{INDENT * indent}STRING {display}{CASE_TEXT[self.case_flags]}")
...
class Literal(String):
    def dump(self, indent, reverse):
        ...
        print(f"{INDENT * indent}LITERAL MATCH {display}{CASE_TEXT[self.case_flags]}")
...
class StringSet(Branch):
    ...
    def dump(self, indent, reverse):
        print(f"{INDENT * indent}STRING_SET {self.name}{CASE_TEXT[self.case_flags]}")

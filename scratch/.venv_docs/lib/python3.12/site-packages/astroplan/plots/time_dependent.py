...
def plot_airmass(targets, observer, time, ax=None, style_kwargs=None,
    ...
    r"""Plots airmass as a function of time for a given target.
...
def plot_altitude(targets, observer, time, ax=None, style_kwargs=None,
    ...
    r"""Plots altitude as a function of time for a given target.
    ...
    ax.set_xlabel(f"Time from {min(time).datetime.date()} [UTC]")

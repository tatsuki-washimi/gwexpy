...
def get_coinc_def_id(
    xmldoc, search, search_coinc_type, create_new=True, description=""
):
    """
    Wrapper for the get_coinc_def_id() method of the CoincDefiner table
    class in igwn_ligolw.lsctables.  This wrapper will optionally create a
    ...
    return coincdeftable.get_coinc_def_id(
        search, search_coinc_type, create_new=create_new, description=description
    )

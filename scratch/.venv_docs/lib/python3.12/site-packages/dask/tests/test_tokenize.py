...
def test_tokenize_datetime_time():
    # Same time
    check_tokenize(datetime.time(1, 2, 3, 4, datetime.UTC))
    ...
    ) != check_tokenize(datetime.time(2, 2, 3, 4, datetime.UTC))
    # Different minute
    assert check_tokenize(
        datetime.time(1, 2, 3, 4, datetime.UTC)
    ) != check_tokenize(datetime.time(1, 3, 3, 4, datetime.UTC))
    # Different second
    assert check_tokenize(
        datetime.time(1, 2, 3, 4, datetime.UTC)
    ) != check_tokenize(datetime.time(1, 2, 4, 4, datetime.UTC))
    # Different micros
    assert check_tokenize(
        datetime.time(1, 2, 3, 4, datetime.UTC)
    ) != check_tokenize(datetime.time(1, 2, 3, 5, datetime.UTC))
    # Different tz
    assert check_tokenize(
        datetime.time(1, 2, 3, 4, datetime.UTC)
    ) != check_tokenize(datetime.time(1, 2, 3, 4))
...
def test_tokenize_datetime_datetime():
    ...
    # Different year
    assert check_tokenize(
        datetime.datetime(1, 2, 3, 4, 5, 6, 7, datetime.UTC)
    ) != check_tokenize(datetime.datetime(2, 2, 3, 4, 5, 6, 7, datetime.UTC))
    # Different month
    assert check_tokenize(
        datetime.datetime(1, 2, 3, 4, 5, 6, 7, datetime.UTC)
    ) != check_tokenize(datetime.datetime(1, 1, 3, 4, 5, 6, 7, datetime.UTC))
    # Different day
    assert check_tokenize(
        datetime.datetime(1, 2, 3, 4, 5, 6, 7, datetime.UTC)
    ) != check_tokenize(datetime.datetime(1, 2, 2, 4, 5, 6, 7, datetime.UTC))
    # Different hour
    assert check_tokenize(
        datetime.datetime(1, 2, 3, 4, 5, 6, 7, datetime.UTC)
    ) != check_tokenize(datetime.datetime(1, 2, 3, 3, 5, 6, 7, datetime.UTC))
    # Different minute
    assert check_tokenize(
        datetime.datetime(1, 2, 3, 4, 5, 6, 7, datetime.UTC)
    ) != check_tokenize(datetime.datetime(1, 2, 3, 4, 4, 6, 7, datetime.UTC))
    # Different second
    assert check_tokenize(
        datetime.datetime(1, 2, 3, 4, 5, 6, 7, datetime.UTC)
    ) != check_tokenize(datetime.datetime(1, 2, 3, 4, 5, 5, 7, datetime.UTC))
    # Different micros
    assert check_tokenize(
        datetime.datetime(1, 2, 3, 4, 5, 6, 7, datetime.UTC)
    ) != check_tokenize(datetime.datetime(1, 2, 3, 4, 5, 6, 6, datetime.UTC))
    # Different tz
    assert check_tokenize(
        datetime.datetime(1, 2, 3, 4, 5, 6, 7, datetime.UTC)

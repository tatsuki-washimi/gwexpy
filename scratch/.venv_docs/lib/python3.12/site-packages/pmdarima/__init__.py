...
if __PMDARIMA_SETUP__:
    ...
    from .arima import ARIMA, AutoARIMA, StepwiseContext, auto_arima, decompose
    ...
    if _py_version < _min_version:
        _warnings.warn(
            ...
            f"older than {_min_version[0]}.{_min_version[1]}. Your python version ({_py_version.major}.{_py_version.minor}.{_py_version.micro}) is "

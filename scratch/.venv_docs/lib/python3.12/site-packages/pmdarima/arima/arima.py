...
from ..utils import check_endog, check_exog, if_has_delegate, is_iterable
from ..utils.array import diff, diff_inv
...
def ARMAtoMA(ar, ma, max_deg):
    r"""Convert ARMA coefficients to infinite MA coefficients.

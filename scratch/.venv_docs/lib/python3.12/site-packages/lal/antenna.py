    ...
    def laldetector(self, det):
        ...
        if isinstance(det, Detector):
            ...
            try:
                ...
                raise KeyError(f"Key {det} is not a valid detector name.")
    ...
    def ra(self, raval):
        ...
        if raval is None:
            ...
            try:
                ...
                raise ValueError(f"Could not convert '{raval}' to a right "
                                 "ascension")
        else:
    ...
    def dec(self, decval):
        ...
        if decval is None:
            ...
            try:
                ...
                raise ValueError(f"Could not convert '{decval}' to a "
                                 "declination")
        else:
    ...
    def lookup_pair(self, pair):
        ...
        for val in pair:
            if val.lower() not in self.parameters:
                raise ValueError(f'Parameter {val} in pair not '
                                 'recognized')

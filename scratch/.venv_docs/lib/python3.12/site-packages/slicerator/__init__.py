...
class Slicerator:
    ...
    def __repr__(self):
        msg = f"Sliced {type(self._ancestor).__name__}. Original repr:\n"
...
class Pipeline:
    ...
    def __repr__(self):
        ...
        msg = f'({anc_str},) processed through {self._proc_func.__name__}. Original repr:\n    '
        ...
        if name in pa:
            for a in self._get_prop_ancestors():
                try:
                    ...
                    pass
        raise AttributeError(f'No attribute `{name}` propagated.')

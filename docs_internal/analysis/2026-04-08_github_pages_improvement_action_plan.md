...
- [x] **Step 8: Python 要件表記の統一【Critical】**
...
- [x] **Step 9: CONTRIBUTING.md の "No Monkeypatching" 方針修正【High】**
...
- [x] **Step 10: MyST admonition 記法の統一【High】**
...
- [x] **Step 11: CLI/GUI ガイドの状態明記【Medium】**
...
- [x] **Step 12: `gwexpy.time` 活用例の追加【Medium】**
...
- [x] **Step 8: API Reference の大量欠落を解消【High】**
...
- [x] **Step 9: Notebook 出力の公開品質基準を適用【Major】**
...
- [x] **Step 10: EN/JA ノートブック同期ポリシーの明文化と適用【Major】**
...
- [x] **Step 11: en/ ツリー内の日本語 notebook を修正【Minor】**
...
- [x] **Step 12: linkcheck の既知2件を修正【Minor】**
...
ドキュメント基盤のプロダクション対応および最終クリーンアップを完了した。

### 実施内容

- **Task 4 (残項目)**:
  - `installation.md` の extras (seismic, control, gui) の同期と Python 3.11 要求の統一。
  - 全ドキュメントの admonition を GitHub 形式から MyST (:::{note}等) へ一括変換。
  - `gwexpy.time` の実行例追加と CLI/GUI プレースホルダ注記。
...
- **インフラ・リンク**:
  ...
  - ページ末尾へのフィードバック導線（GitHub Issues リンク）を `layout.html` に実装。

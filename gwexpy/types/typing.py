...
ArrayLike: TypeAlias = Union[np.ndarray, list, tuple, NumpyArrayLike]

# Index types (coordinate axes)
IndexLike: TypeAlias = Union[XIndex, u.Quantity, np.ndarray]

# Unit types
UnitLike: TypeAlias = Union[u.UnitBase, str, None]

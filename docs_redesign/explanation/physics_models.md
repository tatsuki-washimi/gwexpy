...
- **Related API**: {doc}`../reference/api/analysis` (`gwexpy.analysis.coupling.estimate_coupling`)
...
- **Related API**: {doc}`../reference/api/timeseries` (`TimeSeries.coherence`), {doc}`../reference/api/analysis` (`gwexpy.analysis.bruco`)
...
- **Related API**: {doc}`../reference/api/noise` (`gwexpy.noise.magnetic.schumann_resonance`)
...
- **Related API**: {doc}`../reference/api/noise` (`gwexpy.noise.peaks.voigt_line`)
...
- **Related API**: {doc}`../reference/api/analysis` (`gwexpy.analysis.bruco.FastCoherenceEngine`)
...
- **Related API**: {doc}`../reference/api/analysis`

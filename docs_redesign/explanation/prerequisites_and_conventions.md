...
- Optional dependencies unlock additional features. See the [Installation Guide](../tutorials/installation.md) for setup details.

If you want the shortest overall learning path first, start with [Getting Started](../tutorials/getting_started.md).
...
- Formats that only store local wall-clock time may require an explicit `timezone`. A common example is GBD in the [File I/O Supported Formats Guide](../how-to/io_formats.md).
